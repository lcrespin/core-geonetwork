...
(function() {
  ...
  goog.require('gn_search_sandre_config');
  goog.require('gn_search_sandre_directive');

  var module = angular.module('gn_search_sandre',
      ['gn_search', 'gn_search_sandre_config',
       'gn_search_sandre_directive', 'gn_related_directive',
    ...
    function($scope, $location, suggestService, $http, $translate,
      ...
      $scope.resultviewFns = {
        addMdLayerToMap: function (link, md) {
          ...
          /* Louis Crespin LC 15/12/2016 */
          if (link.contentType == "OGC:WFS") {
            gnMap.addWfsFromScratch(viewerMap, link.url, link.name, false, md).  
            then(function(layer) {
              if(layer) {
